    ...
    <div className="container mx-auto py-6 px-4">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Welcome to PaletteMail. Manage your emails, contacts, and account settings.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <Link href="/dashboard/templates" className="group">
          <div className="border rounded-lg p-6 h-full hover:border-primary hover:shadow-md transition-all flex flex-col">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-semibold group-hover:text-primary">Email Templates</h2>
              <Mail className="h-6 w-6 text-primary/70 group-hover:text-primary" />
            </div>
            <p className="text-gray-600 mb-4 flex-1">Create and manage your email templates with our intuitive editor.</p>
        ...
        <Link href="/dashboard/contacts" className="group">
          <div className="border rounded-lg p-6 h-full hover:border-primary hover:shadow-md transition-all flex flex-col">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-semibold group-hover:text-primary">Contact Lists</h2>
              <Users className="h-6 w-6 text-primary/70 group-hover:text-primary" />
            </div>
            <p className="text-gray-600 mb-4 flex-1">Organize your contacts and recipient lists in one place.</p>
        ...
        <Link href="/dashboard/history" className="group">
          <div className="border rounded-lg p-6 h-full hover:border-primary hover:shadow-md transition-all flex flex-col">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-semibold group-hover:text-primary">Email History</h2>
              <Inbox className="h-6 w-6 text-primary/70 group-hover:text-primary" />
            </div>
            <p className="text-gray-600 mb-4 flex-1">View your sent emails and track delivery status and engagement.</p>
        ...
        <Link href="/dashboard/schedule" className="group">
          <div className="border rounded-lg p-6 h-full hover:border-primary hover:shadow-md transition-all flex flex-col">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-semibold group-hover:text-primary">Email Scheduling</h2>
              <Calendar className="h-6 w-6 text-primary/70 group-hover:text-primary" />
            </div>
            <p className="text-gray-600 mb-4 flex-1">Schedule your emails to be sent at the perfect time for your audience.</p>
        ...
        <Link href="/dashboard/profile" className="group">
          <div className="border rounded-lg p-6 h-full hover:border-primary hover:shadow-md transition-all flex flex-col">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-semibold group-hover:text-primary">Account Settings</h2>
              <Settings className="h-6 w-6 text-primary/70 group-hover:text-primary" />
            </div>
            <p className="text-gray-600 mb-4 flex-1">Manage your profile, security settings, and account preferences.</p>
      ...
      <div className="bg-gray-50 rounded-lg p-6 border">
        ...
        <p className="text-gray-600 mb-6">Create and send beautiful emails using PaletteMail templates</p>
