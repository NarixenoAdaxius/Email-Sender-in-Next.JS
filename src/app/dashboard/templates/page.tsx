...
import { PlusIcon, PencilSquareIcon, TrashIcon, LockClosedIcon, GlobeAltIcon } from '@heroicons/react/24/outline';
...
export default function TemplatesPage() {
  ...
  const renderTemplateTable = (templateList: Template[], title: string, icon: React.ReactNode) => {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      {templates.length === 0 ? (
        ...
        <div>
          {renderTemplateTable(privateTemplates, "My Private Templates", <LockClosedIcon className="h-5 w-5 text-gray-600" />)}
          {renderTemplateTable(publicTemplates, "Public Templates", <GlobeAltIcon className="h-5 w-5 text-blue-600" />)}
        </div>
      )}
    </div>
  );
