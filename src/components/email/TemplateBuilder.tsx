...
const TemplateBuilder: React.FC<TemplateBuilderProps> = ({ templateId, onSave }) => {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="space-y-4">
            ...
            <div className="mt-1 rounded-md border border-gray-300 bg-gray-50 p-3">
              {template.variables.length > 0 ? (
                ...
                <p className="text-sm text-gray-500">
                  No variables detected. Add variables using {"{{variableName}}"} syntax in your template.
                </p>
              )}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">
              Preview
              {isPreviewUpdating && <span className="ml-2 text-xs text-blue-500">Updating...</span>}
            </label>
            <div className={`mt-1 rounded-md border border-gray-300 bg-white p-3 transition-all duration-300 ${isPreviewUpdating ? 'border-blue-300 shadow-sm' : ''}`}>
              <iframe
                title="Email Preview"
      ...
      <div className="col-span-2">
        ...
        <p className="mt-1 text-xs text-gray-500">
          ...
          <span className="font-medium text-primary"> {'{{senderName}}'}</span> is a special variable used for the "From" name in emails.
        </p>
      </div>
