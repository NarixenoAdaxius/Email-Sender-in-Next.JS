 ...
 */
export async function uploadToCloudinary(file: Buffer, folderName: string = 'uploads') {
  try {
 ...
 */
export async function uploadImageFromUrl(imageUrl: string, folderName: string = 'uploads') {
  try {
